...
export default function HomePage() {
  return (
    <div className="relative flex min-h-screen flex-1 flex-col items-center justify-center overflow-hidden px-4 pb-24 pt-12">
      <div
        className="pointer-events-none absolute inset-0 bg-[#ebe4d8]"
        style={{
          backgroundImage:
            "radial-gradient(rgba(22, 163, 74, 0.09) 1.2px, transparent 1.2px)",
      ...
      <div className="relative z-10 flex w-full flex-col items-center pt-10 sm:pt-8">
        <RoleSelector />
        <footer className="mt-14 text-center text-sm text-stone-600">
          CECYTEBC © 2025
        </footer>
      </div>
      ...
      <Link
        ...
        className="fixed bottom-5 right-5 z-20 flex max-w-[calc(100vw-2rem)] items-center gap-2 rounded-full border border-stone-400/70 bg-white/90 px-3 py-2 text-xs font-medium text-stone-700 shadow-lg backdrop-blur-sm transition hover:border-[#16a34a]/70 hover:bg-white hover:text-stone-900 sm:text-sm"
