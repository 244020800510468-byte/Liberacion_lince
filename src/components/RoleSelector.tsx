  ...
  return (
    <div className="flex w-full max-w-2xl flex-col items-center gap-10 px-4">
      ...
      <div className="grid w-full gap-6 sm:grid-cols-2">
        <Link
          href="/login/admin"
          className="group flex min-h-[148px] flex-col items-center justify-center gap-4 rounded-2xl border-2 border-[#16a34a] bg-[#dfd6c8] px-6 py-8 text-center shadow-md shadow-[#22c55e]/25 transition-all duration-200 hover:scale-[1.02] hover:border-[#15803d] hover:bg-[#d4cbbf] hover:shadow-lg hover:shadow-[#22c55e]/35"
        >
